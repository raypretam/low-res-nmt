...
The many-to-English SixT+ model checkpoint [[download (5.6GB)](https://huggingface.co/SUSTech-NLP/acl22_sixtp/resolve/main/x2e.pt)]

The many-to-many SixT+ model checkpoint [[download (5.6GB)](https://huggingface.co/SUSTech-NLP/acl22_sixtp/resolve/main/x2x.pt)]
